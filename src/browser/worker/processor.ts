...
import type { DecodeWorkerRequest, DecodeWorkerSuccess } from './protocol.js';

export function processDecodeRequest(request: DecodeWorkerRequest): DecodeWorkerSuccess {
